...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <title>ギルクエ編集 / MH4G情報管理.com</title>
        <!-- Fonts -->
        ...
        <body class="bg-gray-200">
            <div class="w-[92%] min-h-[85vh] mx-auto bg-white shadow">
                <div class="w-[40%] mx-auto  space-y-6 ">
                    <h1 class="inline-block align-middle text-4xl font-semibold py-6">ギルクエ編集</h1>
                    <div>
                        <form action="/posts/{{ $post->id }}" method="POST">
                            ...
                            <table class="shadow  w-full  ">
                                <tr class="border-b ">
                                    ...
                                    <td>
                                        <input type="text" name='post[default_level]' id="Level" class="w-[30%] ml-4 my-3 rounded  ">
                                    </td>
                                </tr>
                                <tr class="border-b ">
                                    <td>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td>
                                        <input type="text" name='post[generator]' id="generator" class="w-[30%] ml-4 my-3 rounded">
                                    </td>
                                </tr>
                                <tr class="border-b">
                                    <td>
                                        <label for="remark" class=" mx-3 mb-0 ext-xl font-semibold text-gray-900 ">備考</label>
                                    </td>
                                    <td>
                                        <textarea id="remark" rows=4 maxlength="250" name='post[remark]' class="ml-4 my-3 block p-2.5 w-[80%] text-left text-xl text-gray-900 bg-gray-50 rounded-lg">{{ $post->remark}}</textarea>
                                    </td>
                                </tr>
                            </table>
                            <div class="flex items-center justify-center p-6 space-x-2 border-t  ">
                                <input type="submit" value="保存" class="mx-auto bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border-2 border-gray-400 rounded"/>
                            </div>
                        </form>
                    </div>
            ...
            <script>
                ...
                document.getElementById('RMonsterArea').value = "{{ $post->right_monster_area}}";
                document.getElementById('Area1').value = "{{ $post->area_1_id}}";
                document.getElementById('Area2').value = "{{ $post->area_2_id}}";
                document.getElementById('Area3').value = "{{ $post->area_3_id}}";
                document.getElementById('Area4').value = "{{ $post->area_4_id}}";
                document.getElementById('TreasureArea').value = "{{ $post->treasure_area_number}}";
                document.getElementById('Weapon').value = "{{ $post->weapon_id}}";
                document.getElementById('Armor').value = "{{ $post->armor_id}}";
